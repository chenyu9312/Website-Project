<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserGridView.ascx.cs" Inherits="ProgramInformationApplication.UserGridView" %>
<header>
    <style>
        .short td{
            padding-left:10px;
...
<asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="False"  
    ...
    onrowcommand="gvFiles_RowCommand" onrowdatabound="gvFiles_RowDataBound" CssClass="short">
